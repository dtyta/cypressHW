describe('Registration and Authorization test', () => {
    it('Registration test', () => {
      ...
      cy.get('[id="AccountFrm_email"]').click().type('maxpower@gmail.com');
      ...
      cy.get('[id="AccountFrm_loginname"]').click().type('Tolik88');
      ...
      cy.get('[class="maintext"]', {timeout: 5000}).should('contain', ' Your Account Has Been Created!');
    })
